...
int main(){
    ...
    numBytesPular = (int)((double)(segundosComeco*(wavCab.BitsPerSample/8))/((double)16*pow((double)10, (double)-6)));
    numSamplesLer = (int)((double)(segundosDuracao)/((double)16*pow((double)10, (double)-6)));
